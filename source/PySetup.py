...
dest_file = identity + iversion  # Final name of .exe file
dest_folder = identity + iversion # Final folder for the files
icon_file = ""  # Icon file. Leave blank for the pygame icon.
extra_data = ["images", "LiberationMono-Regular.ttf"]
            # Extra data to copy in the final folder
...
copyright = "Copyright (C) 2010, Christopher Fredericks"
author = "Christopher Fredericks"
company = "zsouthboy.com"
version = iversion
